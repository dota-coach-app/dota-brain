...
export interface IHeroContent {
  ...
  /**
   * True if guide is under review or needs to be reviewed,
   * e.g., after major patch release.
   *
...
export interface IHeroBuild {
   ...
   *
   */
  facet: number | number[] | null; // 'null' to be removed once all guides are updated!
  abilities: string[];
  items: ItemBuild;
...
export const heroBuilds: { [key: string]: IHeroContent } = {
  ...
  alchemist: {
    ...
    builds: [
      {
        ...
        items: {
          starting: [
            ...
            "quelling_blade",
            "gauntlets",
            //"magic_stick", removed by Dota Coach, as costs were too high (20.6.2024)
            "branches",
            "circlet",
          ],
          early_game: ["bracer", "power_treads", "magic_wand", "null_talisman"],
          mid_game: ["radiance", "blink", "black_king_bar", "assault"],
          late_game: ["abyssal_blade", "bloodthorn", "overwhelming_blink"],
          situational: [
            "manta",
            "sange_and_yasha",
            "silver_edge",
      ...
      // @TNTCNz: Michel reintriduced mid guide. CAn you review?
      // It's ok if the content is very similar or even the same as for the carry role
      // But we should not remove and guides.
      {
    ...
    // @TNTCNz: Is there an ability & item combo for him?!
    combo: [],
    // Michel added old counter_items again, please review
    counter_items: {
      laning_phase: {
  ...
  axe: {
    ...
    counter_items: {
      ...
      mid_game: {
        ...
        core: ["mage_slayer", `sange_and_yasha`, "silver_edge"],
      },
      late_game: {
        all: [],
        support: [],
  ...
  bane: {
    ...
    builds: [
      {
        ...
        abilities: [
          ...
          "bane_fiends_grip", // 12
          `bane_enfeeble`, // 13
          `special_bonus_unique_bane_11`, // 14
          `special_bonus_unique_bane_9`, // 15 | Enfeeble Cast Range Reduction
          `bane_brain_sap`, // 16
          "special_bonus_attributes", // 17
          "bane_fiends_grip", // 18
          "special_bonus_attributes", // 19
    ...
    counter_items: {
      ...
      mid_game: {
        ...
        core: [`sange_and_yasha`, `black_king_bar`],
      },
      late_game: {
  ...
  beastmaster: {
    ...
    counter_items: {
      ...
      mid_game: {
        ...
        core: [`crimson_guard`, `sange_and_yasha`, `gungir`],
      },
      late_game: {
        all: ["sphere"],
        support: [],
  ...
  bloodseeker: {
    ...
    counter_items: {
      ...
      mid_game: {
        ...
        core: [`blade_mail`, `sange_and_yasha`],
      },
      late_game: {
        all: ["sphere", "sheepstick"],
        support: [],
    ...
    builds: [
      {
        ...
        items: {
          ...
          early_game: ["bracer", `magic_wand`, "arcane_boots", "vanguard"],
          mid_game: [
            `ultimate_scepter`,
            `bloodstone`,
            `aghanims_shard`,
    ...
    builds: [
      {
        ...
        abilities: [
          ...
          "broodmother_incapacitating_bite", // 10
        ...
        items: {
          ...
          late_game: ["skadi", "butterfly", `sheepstick`, "assault"],
          situational: [
            `spirit_vessel`,
            `orb_of_corrosion`,
            `arcane_boots`,
    ...
    builds: [
      {
        ...
        items: {
          starting: [
            ...
            `gauntlets`,
            `circlet`,
            //`branches`, removed by Dota Coach as costs were 610 (20.6.2024)
          ],
          early_game: [`bracer`, `bracer`, `bracer`],
          mid_game: [`blade_mail`, `blink`, `eternal_shroud`, `aghanims_shard`],
          late_game: [`heart`, `black_king_bar`, `overwhelming_blink`],
          situational: [
            "heavens_halberd",
            `shivas_guard`,
            `ultimate_scepter`,
    ...
    builds: [
      {
        ...
        items: {
          ...
          early_game: ["bracer", "power_treads", "magic_wand", "armlet"],
          mid_game: ["orchid", "manta", "blink"],
          late_game: ["black_king_bar", "aghanims_shard", "heart", "assault"],
          situational: ["sphere", "silver_edge", "nullifier"],
          core: [
            "power_treads",
            "armlet",
            "orchid",
      ...
      },
      {
        ...
        items: {
          ...
          early_game: ["bracer", "power_treads", "magic_wand"],
    ...
    builds: [
      {
        ...
        abilities: [
          ...
          `rattletrap_power_cogs`, // 3
          `rattletrap_battery_assault`, // 4
          `rattletrap_power_cogs`, // 5
          "rattletrap_hookshot", // 6
          `rattletrap_power_cogs`, // 7
          "rattletrap_rocket_flare", // 8
          `rattletrap_battery_assault`, // 9
          `special_bonus_unique_clockwerk_9`, // 10
          `rattletrap_battery_assault`, // 11
          "rattletrap_hookshot", // 12
          `rattletrap_rocket_flare`, // 13
          `rattletrap_rocket_flare`, // 14
          `special_bonus_unique_clockwerk_5`, // 15
          `rattletrap_rocket_flare`, // 16
          "special_bonus_attributes", // 17
    ...
    builds: [
      {
        ...
        abilities: [
          ...
          "special_bonus_attributes", // 19
          `special_bonus_unique_dark_seer_13`, // 20
          "special_bonus_attributes", // 21
          "special_bonus_attributes", // 22
          "special_bonus_attributes", // 23
          "special_bonus_attributes", // 24
    ...
    builds: [
      {
        ...
        abilities: [
          ...
          "special_bonus_unique_dark_willow_6", // 15
          "special_bonus_unique_dark_willow_4", // 16
          "special_bonus_attributes", // 17
        ...
        items: {
          ...
          mid_game: ["cyclone", "aghanims_shard", "blink", "aether_lens"],
          late_game: [
            "octarine_core",
            "boots_of_bearing",
            "wind_waker",
    ...
    builds: [
      {
        ...
        items: {
          ...
          early_game: [`boots`, `magic_wand`, `ring_of_basilius`, `wind_lace`],
          mid_game: [`arcane_boots`, "pavise", `solar_crest`, "aghanims_shard"],
          late_game: [
            "blink",
            `ultimate_scepter`,
            "holy_locket",
      ...
      },
      {
        ...
        items: {
          ...
          early_game: ["bracer", "soul_ring", "phase_boots", "magic_wand"],
          mid_game: [
            "echo_sabre",
            "black_king_bar",
            "aghanims_shard",
  ...
  doom_bringer: {
    ...
    counter_items: {
      ...
      mid_game: {
        ...
        support: ["glimmer_cape", "force_staff"],
        core: ["pipe", "black_king_bar", `sange_and_yasha`],
      },
      late_game: {
        all: ["sphere", "wind_waker"],
        support: ["black_king_bar"],
  ...
  dragon_knight: {
    ...
    counter_items: {
      ...
      mid_game: {
        all: ["spirit_vessel"],
        support: ["glimmer_cape", "force_staff"],
        core: [`maelstrom`, `silver_edge`, `sange_and_yasha`],
      },
      late_game: {
        all: ["sphere"],
        support: [],
    ...
    builds: [
      {
        ...
        items: {
          ...
          mid_game: ["yasha", "ultimate_scepter", "hurricane_pike", "manta"],
          late_game: [
            "black_king_bar",
            "butterfly",
            "aghanims_shard",
          ...
          situational: ["sphere", "mjollnir", "hand_of_midas", "blink"],
          core: [
            "power_treads",
            "ultimate_scepter",
            "hurricane_pike",
    ...
    builds: [
      {
        ...
        abilities: [
          ...
          "special_bonus_attributes", // 23
          "special_bonus_attributes", // 24
          "special_bonus_unique_earthshaker_echo_cd", // 25
        ],
        items: {
          starting: [
            `tango`,
    ...
    builds: [
      {
        ...
        items: {
          ...
          late_game: ["skadi", "butterfly", "refresher", "greater_crit"],
          situational: [
            "manta",
            "hand_of_midas",
            "sphere",
    ...
    builds: [
      {
        ...
        abilities: [
          ...
          `gyrocopter_flak_cannon`, // 9
          `gyrocopter_flak_cannon`, // 10
      ...
      },
      {
        ...
        abilities: [
          ...
          `special_bonus_unique_gyrocopter_homing_missile_damage`, // 10
        ...
        items: {
          ...
          late_game: [`ethereal_blade`, `blink`, `octarine_core`, `refresher`],
          situational: [
            `tranquil_boots`,
            `spirit_vessel`,
            `veil_of_discord`,
    ...
    builds: [
      {
        ...
        abilities: [
          ...
          `hoodwink_acorn_shot`, // 3
          "hoodwink_scurry", // 4
          "hoodwink_bushwhack", // 5
          "hoodwink_sharpshooter", // 6
          `hoodwink_acorn_shot`, // 7
          "hoodwink_acorn_shot", // 8
          `hoodwink_bushwhack`, // 9
          `hoodwink_bushwhack`, // 10
          `special_bonus_unique_hoodwink_bushwhack_cooldown`, // 11
        ...
        items: {
          ...
          late_game: [`blink`, `greater_crit`, `hurricane_pike`, `sheepstick`],
          situational: [
            `veil_of_discord`,
            `spirit_vessel`,
            `aether_lens`,
    ...
    builds: [
      {
        ...
        abilities: [
          ...
          "special_bonus_unique_huskar_3", // 11
          `huskar_life_break`, // 12
          "huskar_inner_fire", // 13
          `huskar_inner_fire`, // 14
          "special_bonus_lifesteal_15", // 15
          "huskar_inner_fire", // 16
          "special_bonus_attributes", // 17
    ...
    builds: [
      {
        ...
        abilities: [
          ...
          `special_bonus_unique_invoker_11`, // 20
    ...
    builds: [
      {
        ...
        abilities: [
          ...
          `special_bonus_unique_jakiro_6`, // 16
          "special_bonus_attributes", // 17
          "jakiro_macropyre", // 18
          "special_bonus_attributes", // 19
          ...
          "special_bonus_attributes", // 23
          "special_bonus_attributes", // 24
          `special_bonus_unique_jakiro_3`, // 25
        ],
        items: {
          starting: [
            "tango",
    ...
    builds: [
      {
        ...
        items: {
          ...
          late_game: [`aghanims_shard`, `sheepstick`, `wind_waker`, `dagon_5`],
          situational: [
            `veil_of_discord`,
            `pavise`,
            `solar_crest`,
  ...
  legion_commander: {
    ...
    builds: [
      {
        ...
        items: {
          ...
          mid_game: [`blade_mail`, `blink`, `black_king_bar`, `aghanims_shard`],
          late_game: [
            `ultimate_scepter`,
            `assault`,
            `octarine_core`,
    ...
    counter_items: {
      ...
      mid_game: {
        all: ["cyclone"],
        support: ["ghost"],
        core: [`heavens_halberd`, `sange_and_yasha`],
      },
      late_game: {
    ...
    builds: [
      {
        ...
        abilities: [
          ...
          "special_bonus_attributes", // 23
          "special_bonus_attributes", // 24
          `special_bonus_unique_lich_5`, // 25
        ],
        items: {
          starting: [
            "tango",
    ...
    builds: [
      ...
      // TO BE UPDATED BY YOONA
      {
        ...
        items: {
          ...
          mid_game: [`maelstrom`, `gungir`, `travel_boots`, `black_king_bar`],
          late_game: [
            `hurricane_pike`,
            `greater_crit`,
            `satanic`,
    ...
    builds: [
      {
        ...
        items: {
          ...
          mid_game: ["manta", "black_king_bar", "dragon_lance", "lesser_crit"],
          late_game: [
            "hurricane_pike",
            "angels_demise",
            "blink",
    ...
    builds: [
      {
        ...
        abilities: [
          ...
          "special_bonus_unique_lycan_howl_armor", // 11
          "lycan_shapeshift", // 12
          "lycan_howl", // 13
          "lycan_howl", // 14
      ...
      },
      {
        ...
        items: {
          ...
          mid_game: ["vladmir", "assault", "black_king_bar", "aghanims_shard"],
          late_game: [
            "bloodthorn",
            "nullifier",
            `ultimate_scepter`,
    ...
    builds: [
      {
        ...
        abilities: [
          ...
          "special_bonus_unique_outworld_devourer_3", // 15
    ...
    builds: [
      {
        ...
        items: {
          ...
          mid_game: ["echo_sabre", "blink", "manta", "aghanims_shard"],
          late_game: [
            "ultimate_scepter",
            "shivas_guard",
            "harpoon",
      ...
      },
      {
        ...
        items: {
          ...
          late_game: [`aghanims_shard`, `harpoon`, `assault`, `abyssal_blade`],
          situational: [
            `ring_of_basilius`,
            `orb_of_corrosion`,
            `arcane_boots`,
  ...
  pudge: {
    ...
    counter_items: {
      ...
      mid_game: {
        ...
        support: ["glimmer_cape", "force_staff", "cyclone"],
        core: ["desolator", "mage_slayer", "hurricane_pike", `sange_and_yasha`],
      },
      late_game: {
        all: ["sphere", "wind_waker"],
        support: [],
    ...
    builds: [
      {
        ...
        items: {
          ...
          late_game: [`satanic`, `butterfly`, `refresher`, `assault`],
          situational: [
            `phase_boots`,
            `hand_of_midas`,
            `mage_slayer`,
      ...
      },
      {
        ...
        abilities: [
          ...
          "razor_unstable_current", // 8
          `razor_unstable_current`, // 9
          `razor_unstable_current`, // 10
          `special_bonus_spell_lifesteal_10`, // 11
          "razor_eye_of_the_storm", // 12
        ...
        items: {
          ...
          late_game: [`butterfly`, `sheepstick`, `refresher`, `assault`],
          situational: [
            `phase_boots`,
            `falcon_blade`,
            `veil_of_discord`,
      ...
      },
      {
        ...
        items: {
          ...
          late_game: [`sheepstick`, `refresher`, `assault`, `swift_blink`],
          situational: [
            `phase_boots`,
            `falcon_blade`,
            `hand_of_midas`,
  ...
  shadow_shaman: {
    ...
    counter_items: {
      ...
      mid_game: {
        all: ["lotus_orb"],
        support: ["force_staff", "glimmer_cape"],
        core: [`orchid`, `black_king_bar`, `sange_and_yasha`],
      },
      late_game: {
        all: ["sphere"],
        support: ["black_king_bar"],
    ...
    builds: [
      {
        ...
        abilities: [
          ...
          `special_bonus_unique_skywrath`, // 15
          `skywrath_mage_concussive_shot`, // 16
          "special_bonus_attributes", // 17
  ...
  slardar: {
    ...
    counter_items: {
      ...
      mid_game: {
        all: ["lotus_orb", "solar_crest", "heavens_halberd"],
  ...
  tidehunter: {
    ...
    counter_items: {
      ...
      mid_game: {
        all: ["mekansm"],
        support: ["glimmer_cape", "force_staff"],
        core: ["black_king_bar", "silver_edge", `sange_and_yasha`],
      },
      late_game: {
        all: ["wind_waker"],
  ...
  tinker: {
    ...
    builds: [
      {
        ...
        abilities: [
          ...
          `special_bonus_unique_tinker`, // 15
          ...
          "special_bonus_attributes", // 23
          "special_bonus_attributes", // 24
          "special_bonus_unique_tinker_4", // 25
        ],
        items: {
          starting: [
            `tango`,
    ...
    counter_items: {
      ...
      late_game: {
        all: ["sheepstick", "sphere", "aeon_disk"],
        support: ["ward_observer", "black_king_bar", "travel_boots"],
    ...
    builds: [
      {
        ...
        items: {
          ...
          mid_game: [`blink`, "aghanims_shard", `cyclone`, `force_staff`],
          late_game: [
            `ultimate_scepter`,
            `boots_of_bearing`,
            `octarine_core`,
      ...
      },
      {
        ...
        items: {
          ...
          late_game: ["black_king_bar", `harpoon`, `assault`, `octarine_core`],
          situational: [
            "blight_stone",
            "orb_of_corrosion",
            `veil_of_discord`,
    ...
    builds: [
      {
        ...
        items: {
          ...
          late_game: [`shivas_guard`, `blink`, `sheepstick`, `octarine_core`],
          situational: [
            `power_treads`,
            `veil_of_discord`,
            `vanguard`,
      ...
      },
      {
        ...
        items: {
          ...
          late_game: [`force_staff`, `blink`, `sheepstick`, `wind_waker`],
          situational: [
            `tranquil_boots`,
            `urn_of_shadows`,
            `spirit_vessel`,
    ...
    builds: [
      {
        ...
        items: {
          ...
          late_game: [`wind_waker`, `refresher`, `sheepstick`, `octarine_core`],
          situational: [
            `null_talisman`,
            `holy_locket`,
            `pavise`,
    ...
    builds: [
      {
        ...
        abilities: [
          ...
          `witch_doctor_voodoo_restoration`, // 5
          "witch_doctor_death_ward", // 6
          `witch_doctor_voodoo_restoration`, // 7
          `witch_doctor_maledict`, // 8
          `witch_doctor_maledict`, // 9
          `special_bonus_unique_witch_doctor_4`, // 10
          `witch_doctor_maledict`, // 11
          "witch_doctor_death_ward", // 12
          `witch_doctor_paralyzing_cask`, // 13
          `witch_doctor_paralyzing_cask`, // 14
          `witch_doctor_paralyzing_cask`, // 15
          `special_bonus_unique_witch_doctor_3`, // 16
          "special_bonus_attributes", // 17
    ...
    builds: [
      {
        ...
        abilities: [
          ...
          `zuus_heavenly_jump`, // 11
          "zuus_thundergods_wrath", // 12
          `zuus_heavenly_jump`, // 13
          `zuus_heavenly_jump`, // 14
          `special_bonus_unique_zeus_jump_cooldown`, // 15
          `special_bonus_unique_zeus_jump_postjump_movespeed`, // 16
          "special_bonus_attributes", // 17
